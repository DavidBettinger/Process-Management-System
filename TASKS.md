...
### [ ] T0.1 Create mono-repo skeleton
...
### [ ] T0.2 Add basic .editorconfig and formatting config
...
### [ ] T1.1 Initialize Spring Boot project (Gradle)
**Objective:** Create Spring Boot app with web + validation.
**Files:** `backend/build.gradle`, `backend/src/main/...`
